...
class BEFTNFTAcctest {


    async BEFTNftAccPreprocess() {
        //Click on Transfer menu
        await $('android=new UiSelector().description("ট্রান্সফার").instance(0)').click();
        await $('~অন্য ব্যাংকের অ্যাকাউন্টে ট্রান্সফার (BEFTN)').click();
        ...
        const beneficiaryName = data.BEFTNAccountBeneficiaryInfo.searchByName;
        await searchBeneficiary.setValue(beneficiaryName, toString());
        const beneficiaryAccNo = data.BEFTNAccountBeneficiaryInfo.beneficiaryAccountNo;
        ...
        const transferAmount = data.BEFTNAccountBeneficiaryInfo.amount;
...
module.exports = new BEFTNFTAcctest();