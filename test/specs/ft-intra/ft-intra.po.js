...
class IntraFTtest {
    ...
    async selectFromAccount() {
        let element = await driver.$('//*[contains(@content-desc, "0200010000161")]');
    ...
    async intraFTPreprocess() {
        //Click on Transfer menu
        await $('android=new UiSelector().description("ট্রান্সফার").instance(0)').click();
        await $('~অগ্রণী ব্যাংকের অন্যান্য অ্যাকাউন্টে ট্রান্সফার').click();
        ...
        const beneficiaryName = data.intraFTBeneficiaryInfo.searchByName;
        await searchBeneficiary.setValue(beneficiaryName, toString());
        const beneficiaryAccNo = data.intraFTBeneficiaryInfo.beneficiaryAccountNo;
        ...
        const transferAmount = data.intraFTBeneficiaryInfo.amount;
...
module.exports = new IntraFTtest();