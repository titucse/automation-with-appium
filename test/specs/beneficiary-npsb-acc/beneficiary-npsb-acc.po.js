...
class NPSBBeneficiaryAcc {
    ...
    async addBeneficiary() {
        ...
        const accountNo = data.npsbBeneficiaryacc.accountno;
        ...
        const accountname = data.npsbBeneficiaryacc.nickname;
        // Enter account number
        ...
        const holdername = data.npsbBeneficiaryacc.accholdername;
        // Enter account holder name
        await accountHolderName.setValue(holdername.toString());
        // wait for 3 seconds
        await driver.pause(1000);
        ...
        const mobileNo = data.npsbBeneficiaryacc.mobileno;
        // Enter mobile number
        ...
        // await SelectbranchName.waitForDisplayed();  
        // click on bank name
    ...
    async duplicateaddBeneficiary() {
        ...
        const title = await $('~এই বেনিফিশিয়ারি ইতিমধ্যে বিদ্যমান');
        // verify that the page title is displayed
...
module.exports = new NPSBBeneficiaryAcc();