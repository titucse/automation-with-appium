...
class BEFTNBeneficiaryCard {
    ...
    async addBeneficiary() {
        ...
        const cardNo = data.beftnBeneficiarycard.cardno;
        ...
        const cardName = data.beftnBeneficiarycard.nickname;
        // Enter nick name
        ...
        const cardholdername = data.beftnBeneficiarycard.cardholdername;
        // Enter account holder name
        await accountHolderName.setValue(cardholdername.toString());
        // wait for 3 seconds
        await driver.pause(3000);
        ...
        const mobileno = data.beftnBeneficiarycard.mobileno;
        // Enter mobile number
...
module.exports = new BEFTNBeneficiaryCard();