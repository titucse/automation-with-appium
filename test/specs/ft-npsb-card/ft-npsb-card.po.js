...
class NPSBFTCardtest {


    async NPSBftCardPreprocess() {
        //Click on Transfer menu
        await $('android=new UiSelector().description("ট্রান্সফার").instance(0)').click();
        await $('~অন্য ব্যাংকের কার্ডে ট্রান্সফার (NPSB)').click();
        ...
        const beneficiaryName = data.NPSBCardBeneficiaryInfo.searchByName;
        await searchBeneficiary.setValue(beneficiaryName, toString());
        const beneficiaryAccNo = data.NPSBCardBeneficiaryInfo.beneficiaryAccountNo;
        ...
        const transferAmount = data.NPSBCardBeneficiaryInfo.amount;
...
module.exports = new NPSBFTCardtest();