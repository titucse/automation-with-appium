...
class BEFTNFTCardtest {

    async BEFTNftCardPreprocess() {
        //Click on Transfer menu
        await $('android=new UiSelector().description("ট্রান্সফার").instance(0)').click();
        await $('~অন্য ব্যাংকের কার্ডে ট্রান্সফার (BEFTN)').click();
        ...
        const beneficiaryName = data.BEFTNCardBeneficiaryInfo.searchByName;
        await searchBeneficiary.setValue(beneficiaryName, toString());
        const beneficiaryAccNo = data.BEFTNCardBeneficiaryInfo.beneficiaryAccountNo;
        ...
        const transferAmount = data.BEFTNCardBeneficiaryInfo.amount;
...
module.exports = new BEFTNFTCardtest();